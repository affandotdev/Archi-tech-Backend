...
from src.presentation.controllers.mfa_controller import (MFASetupView,
                                                         VerifyMFAView)
...
from src.presentation.controllers.ProfessionRequest_controller import (
    ApproveProfessionView, ListProfessionRequestsView, RejectProfessionView,
    SubmitProfessionRequestView)
# Profile controllers
from src.presentation.controllers.profile_controller import (
    UserProfileController, UserProfileImageUploadController,
...
auth_urlpatterns = [
    ...
    path(
        ...
        admin_user_controller.AdminUserDetailController.as_view(),
    ),
    path(
        "admin/users/<int:user_id>/status/",
        admin_user_controller.AdminUserStatusController.as_view(),
    ),
    path(
        "admin/users/<int:user_id>/role/",
        admin_user_controller.AdminUserRoleController.as_view(),
    ),
    path(
        "admin/users/<int:user_id>/verify/",
        admin_user_controller.AdminUserVerifyController.as_view(),
    ),
    path(
        "admin/dashboard/stats/",
        admin_user_controller.AdminDashboardStatsController.as_view(),
    ),
    path(
        "admin/dashboard/health/",
        admin_user_controller.AdminSystemHealthController.as_view(),
    ),
    ...
    path(
        "admin/profession-request/<uuid:pk>/approve/", ApproveProfessionView.as_view()
    ),
